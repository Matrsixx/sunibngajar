...
<head>
    ...
    <title>Sunibngajar - Register Student</title>
    <link rel="stylesheet" href="Style/registerstudent.css">
</head>
<body>
    ...
    <content>
        <div style="text-align: center;">
            <div class="register-data">
                <form action="controllers/authregister.php" method="POST">
                    <div>
                        <p id="fullname-text">Full Name</p>
                        <div class="text-column">
                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none" id="people-logo">
                                <path d="M19 6.33333C20.6797 6.33333 22.2907 7.00059 23.4784 8.18832C24.6661 9.37605 25.3334 10.987 25.3334 12.6667C25.3334 14.3464 24.6661 15.9573 23.4784 17.145C22.2907 18.3327 20.6797 19 19 19C17.3203 19 15.7094 18.3327 14.5217 17.145C13.334 15.9573 12.6667 14.3464 12.6667 12.6667C12.6667 10.987 13.334 9.37605 14.5217 8.18832C15.7094 7.00059 17.3203 6.33333 19 6.33333ZM19 22.1667C25.9984 22.1667 31.6667 25.0008 31.6667 28.5V31.6667H6.33337V28.5C6.33337 25.0008 12.0017 22.1667 19 22.1667Z" fill="black"/>
                            </svg>
                            <input type="text" name="fullname" placeholder="Binusian" id="fullname-column">
                        </div>
                    </div>
                
                    <div>
                        <p id="fullname-text" >Email</p>

                        <div class="text-column">
                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none" id="people-logo">
                                <path d="M19 6.33333C20.6797 6.33333 22.2907 7.00059 23.4784 8.18832C24.6661 9.37605 25.3334 10.987 25.3334 12.6667C25.3334 14.3464 24.6661 15.9573 23.4784 17.145C22.2907 18.3327 20.6797 19 19 19C17.3203 19 15.7094 18.3327 14.5217 17.145C13.334 15.9573 12.6667 14.3464 12.6667 12.6667C12.6667 10.987 13.334 9.37605 14.5217 8.18832C15.7094 7.00059 17.3203 6.33333 19 6.33333ZM19 22.1667C25.9984 22.1667 31.6667 25.0008 31.6667 28.5V31.6667H6.33337V28.5C6.33337 25.0008 12.0017 22.1667 19 22.1667Z" fill="black"/>
                            </svg>
                            <input type="email" name="email" placeholder="Binusian@gmail.com" id="fullname-column">
                        </div>
                    </div>
        
                    <div>
                        <p id="fullname-text">Password</p>
                        <div class="text-column">
                            <img src="Assets/password.png" width="38" height="38" id="people-logo">
                            <input type="password" name="password" placeholder="********" id="fullname-column">
                        </div>
                        
                    </div>
                    
                    <div>
                        <p id="fullname-text">Confirm Password</p>
                        <div class="text-column">
                            <img src="Assets/password.png" width="38" height="38" id="people-logo">
                            <input type="password" name="confirmpassword" placeholder="********" id="fullname-column">  
                        </div>
                                
                    </div>
                    
                    <div style="text-align: center;">
                        <button name="login" value="login" id="register-button">Register</button>
                    </div>
                </form>
                <br>
                ...
                <div class="social-alt">
                    <svg xmlns="http://www.w3.org/2000/svg" width="39" height="31" viewBox="0 0 39 38" fill="none" class="google">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="49" height="40" viewBox="0 0 49 48" fill="none" class="facebook">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="36" viewBox="0 0 45 44" fill="none" class="apple">
