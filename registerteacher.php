...
<head>
    ...
    <link rel="stylesheet" href="Style/registerteacher.css">
</head>
<body>
            ...
            <div class="register-data">
                <!-- <div>
                    ...
                    <div class="text-column">
                        ...
                        <input type="text" placeholder="Binusian" id="fullname-column">
                    </div>
                </div> -->
                ...
                <div>
                    ...
                    <div class="text-column">
                        ...
                        <input type="email" placeholder="Binusian@gmail.com" id="fullname-column">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="text-column">
                        ...
                        <input type="password" placeholder="********" id="fullname-column">
                    </div>
