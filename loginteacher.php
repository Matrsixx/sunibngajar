...
<head>
    ...
    <title>Sunibngajar - Login Teacher</title>
    <link rel="stylesheet" href="Style/loginteacher.css">
</head>
<body>
    <div class="login-page">
        <header class="header-central">
            ...
            <div class="header-right">
                ...
                <a href="registerteacher.php" id="header-right-signup">Sign Up</a>
                ...
                <div class="input-field">
                    <div class="username">
                        ...
                        <div id="Frame-4-username-div">
                            <input type="email" id="Frame-4-username">
                        </div>  
                    </div>
                    <div class="password">
                        <p id="password">Password</p>
                        <input type="password" id="frame-4-password">
                    </div>
